export default [
    {
        employ: "2020 - NOW ICCS-NTUA | Athens Greece",
        tasks: [
            [
    ...
    {
        employ: '2017 - 2020 RATEPARITY  -  COSMORES  | Piraeus Greece',
        tasks: [
            [
    ...
    {
        employ: `2016 - 2017    ECEP TECHNOLOGIES | London England (remote)`,
        tasks: [
            [
    ...
    {
        employ: `2015 - 2016 SEECAGO | Florida USA (remote)`,
        tasks: [
            [
    ...
    {
        employ: '2014 - 2015 INTERACTIVE DATA | Frankfurt Germany (remote)',
        tasks: [
            [
    ...
    {
        employ: '2012 - 2014 FREELANCE WEB DEVELOPER',
        tasks: [
            [
    ...
    {
        employ: '2001 - 2011 SANOFI AVENTIS S.A | Athens Greece',
        tasks: [
            [
